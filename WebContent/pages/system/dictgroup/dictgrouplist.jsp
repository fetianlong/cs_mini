...
function editEntity(id){
	var dialoguser = $.dialog({
	    id:'dictgroupedit', 
	    title:(id == "")?"新添字典组":"编辑字典组",
		content : 'url:<%=path%>/dictgroup/dictGroupGet.action?id='+id,
		fixed:true,
		width:550,
		height:300,
		resize:false,
...
function deleteEntity(){
	...
	alertconfirm("确认删除选中的数据吗？",function (){
		showLoading();
		$.post('dictGroupDelete.action',$('#sform').serialize(),r_delete,'json').error(requestError);
	});	
}
...
function deleteOneEntity(id){
	...
	alertconfirm("确认删除选中的数据吗？",function (){
		showLoading();
		$.post('dictGroupDelete.action',pars,r_delete,'json').error(requestError);
	});	
}
</script>
</head>
...
<div class="container-fluid">
			<form class="form-horizontal" name="sform" id="sform" method="post" action="<%=path%>/dictgroup/dictGroupSearch.action">
		...
		<div class="row SelectBlock">
			<div class="col-sm-4 col-xs-6">
				<div class="form-group">
					<label for="rEntity.code" class="col-xs-4 control-label">字典组编码</label>
					<div class="col-xs-8">
			...
			<div class="col-sm-4 col-xs-6">
				<div class="form-group">
					<label for="rEntity.remark" class="col-xs-4 control-label">字典组备注</label>
					<div class="col-xs-8">
		...
		<div class="row SubmitButtonBlock">
			...
			<ww:if test="hasPrivilegeUrl('/dictgroup/dictGroupGet.action')"><div class="col-sm-2 col-xs-4">
				<a class="btn btn-block Button2"  onclick="editEntity('');" target="_blank"><i class="fa fa-floppy-o"></i>添加</a>
			</div></ww:if>
			<ww:if test="hasPrivilegeUrl('/dictgroup/dictGroupDelete.action')"><div class="col-sm-2 col-xs-4">
...
<div class="row TableBlock">
					<table class="table table-striped table-bordered table-condensed">
						<tr class="ths" id="tab_bg_cl">
							...
							<td>
								<a href="javascript:SetOrder('code')">字典组编码<img src="<%=path%>/admin/common/images/main/paixu.png"/></a>
							</td>
							<td  >
								<a href="javascript:SetOrder('remark')">字典组备注<img src="<%=path%>/admin/common/images/main/paixu.png"/></a>
							</td>
							<td>
								操作
							</td>
						...
						<ww:iterator value="page.results" id="data" status="rl">
							<tr
								...
								<td align="center">
									<ww:if test="hasPrivilegeUrl('/dictgroup/dictGroupGet.action')">
										<div class="pan_btn3"  onclick="javascript:editEntity('<ww:property value="id"/>');">编辑</div>
									</ww:if>	
									<ww:if test="hasPrivilegeUrl('/dictgroup/dictGroupDelete.action')">
