...
<div class="dlk">
   ...
   <h1>会员登录</h1>  
        <div class="con fl">
          ...
          <input  class="user fl" type="text" name="subscriber.phoneNo" id="phoneNo"  maxlength=11 autocomplete="off" placeholder="请输入用户名" />
        
       </div>
       <div class="con fl">
          <i class="psd_img fl"></i>
          <input class="user fl" type="password" name="subscriber.password" autocomplete="off" id="password"  maxlength=20   placeholder="请输入密码">
