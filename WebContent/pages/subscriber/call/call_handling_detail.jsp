		...
		<table class="xxgl" border="0"  cellpadding="0" cellspacing="0">
			<tr>
             ...
             <tr>
                 ...
                 <td class="zuo1"><span>受&nbsp;理&nbsp;人&nbsp;</span>:</td>
                 <td class="you1">
         ...
         <input type="text"   style="top: 0;left: 0px;visibility:hidden;height:0px;" id="subscriberCallContent"  name="subscriberCall.resultDesc" value="<ww:property value="subscriberCall.content" />"/>
