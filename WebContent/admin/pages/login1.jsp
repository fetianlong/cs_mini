...
<link rel="stylesheet" href="<%=path%>/admin/common/css/login.css">
...
<script type="text/javascript">
    $(function(){
		...
		signinheight=$(".celiangheig").outerHeight();
		merheight=( windowheight-signinheight-100)/2;
		$(".celiangheig").css("margin-top",merheight);
		});
...
<div class="MainContent">
   <div class="container">
	<div class="row">
		<div class="col-xs-12 celiangheig">
			<div class="hertexte">华泰租车后台登录</div>
			<div class="Border"  style="padding:30px;">
				<div class="col-md-8 col-sm-7 hidden-xs SignBlock">
					<div class="row">
						<div class="col-md-3 col-sm-4" style="background: #57afff;">
						<img src="<%=path %>/admin/common/images/login/coninbg1.png">						
						</div>
						<div class="col-md-3 col-md-offset-3 col-sm-4 col-sm-offset-2" style="background: #57afff;">
							<img src="<%=path %>/admin/common/images/login/coninbg2.png">
						</div>
					</div>
					<div class="row">
						<div class="col-md-3 col-md-offset-3 col-sm-4 col-sm-offset-2" style="background: #57afff;">
						<img src="<%=path %>/admin/common/images/login/coninbg3.png">
						</div>
						<div class="col-md-3 col-md-offset-3 col-sm-4 col-sm-offset-2" style="background: #57afff;">
						<img src="<%=path %>/admin/common/images/login/coninbg4.png">	
						</div>
					</div>
				</div>
				<div class="col-md-4 col-sm-4 LoginBlock">
					...
					<form class="form-horizontal" name="loginform" id="loginform" method="post" action="<%=path %>/login.action?type=RTWGGHPWF">
						...
						<div class="form-group has-feedback UsernameCheck has-error">
							...
							<div class="input-group">
											...
											<div class="input-group-addon"><img src="<%=path %>/admin/common/images/login/bg_04.png"></div>
												<ww:if test="@com.dearho.cs.util.CookieTool@getCookieValueByName(request,'cs_admin_authmark')!=NULL">
													<input type="text" class="form-control" id="name" name="name" placeholder="请输入用户名" value="<ww:property value="@com.dearho.cs.util.CookieTool@getCookieValueByName(request,'CS_ADMIN_PHONENO')"/>" >
												</ww:if>
												<ww:else>
						...
						<div class="col-sm-13 Yanzheng">
							<div class="input-group">
										...
										<div class="input-group-addon"><img src="<%=path %>/admin/common/images/login/bg_05.png"></div>
											<ww:if test="@com.dearho.cs.util.CookieTool@getCookieValueByName(request,'cs_admin_authmark') !=NULL">
												<input type="password" class="form-control" id="password"  name="password" maxlength="20"  placeholder="请输入密码" value="111111" >
											</ww:if>
											<ww:else>
						...
						<div class="form-group has-feedback YanzhengCheck has-error">
							<div class="row">
								<div class="col-xs-5 YanzhengInput">
								<label for="validateCode" class="col-sm-3 control-label" style="padding-top:0;"></label>
...
<%-- 								<img src="<%=path%>/yzmimg"> --%>
						...
						<button type="button" id="submitId" onclick="javascript:login();" class="btn btn-primary SubmitButton btn-block">登录</button>
