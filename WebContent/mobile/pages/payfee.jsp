...
<form class="form-horizontal" id="feeForm" method="post" action="<%=path %>/mobile/online/confirmPayOrders.action">
			...
			<div class="row SelectZhifuBlock">
				<div class="col-xs-8 col-xs-offset-2">
					<ww:if test="#request.isEnoughMoney">
						<button onclick="payTypeChange(1)" class="btn btn-default btn-block   ">账户余额 (<ww:property value="formatAmount(#request.UsableAmount)"/>)</button>
					...
					<ww:else>
						...
						<button onclick="payTypeChange(1)" class="btn btn-default btn-block   disabled">账户余额 (<ww:property value="formatAmount(#request.UsableAmount)"/>)</button>
						<button onclick="payTypeChange(5)" class="btn btn-default btn-block " >微信支付</button>
