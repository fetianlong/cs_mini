		...
		*/
		...
		buildNode: function (id, i, level, list, parent) {
			...
			node = {
				...
				level: level,
				parent: parent,
				visible: false // @ move this to better location
			};
		...
		setTreeValues: function (tree) {
			...
			each(tree.children, function (child) {
				...
				if (!child.ignore) {
					...
					// @ Add predicate to avoid looping already ignored children
