...
function makeDaysGrid(startDay,day,intDaysInMonth,newCal,eltName){
	...
	var dat3=d.getFullYear()+"-"+mons+"-"+days;
	    ...
	    daysGrid += '&nbsp;</div></td></tr>';
	    daysGrid += '<tr class=clsthWeek><td><font color=#ff0000>日<font color=#000000></td><td>一</td><td>二</td><td>三</td><td>四</td><td>五</td><td><font color=#ff0000>六<font color=#000000></td></tr><tr>';
	    ...
	    daysGrid += '</tr><tr class=clsth><td colspan=7 style="background:#ffffff;" nowrap><div align=center><font color=red>&nbsp;今天：<a href="javascript:setToday(\''+newToday+'\',\'' + eltName + '\')">'+dat3+'</a>&nbsp;</fond>';
