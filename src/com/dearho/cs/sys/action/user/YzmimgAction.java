...
public class YzmimgAction extends HttpServlet {

	private static final long serialVersionUID = -7003247915622188330L;
	// 设置图形验证码中字符串的字体和大小
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (int i = 0; i < 5; i++) {
        	double rotate = random.nextInt(7) * Math.PI / 180;
            // 取得一个随机字符
