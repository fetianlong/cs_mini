...
public class JsPayOrderPayBackRcveiveAction extends AbstractAction{
	
	private static final long serialVersionUID = 4598081722908212830L;
	
	public static final Log logger = LogFactory.getLog(JsPayOrderPayBackRcveiveAction.class);
