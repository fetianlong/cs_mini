...
public class NativePayRechargeBackRcveiveAction extends AbstractAction{
	
	private static final long serialVersionUID = 4598081722908212830L;
	
	public static final Log logger = LogFactory.getLog(NativePayRechargeBackRcveiveAction.class);
	...
	public void handle() throws Exception {
		...
		try {
			logger.error("NativePayRechargeBackRcveiveAction接收后台通知开始");
          ...
          //  XmlStream.toXML(object)
			...
			logger.error("NativePayRechargeBackRcveiveAction接收后台通知结束");
		}  catch (Exception e) {
			e.printStackTrace();
			logger.error(e);
			XmlResult xmlResult=new XmlResult("SUCCESS", "OK");
