 ...
 *
 */
public class RefundPrepareServlet  extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			System.out.println("A:wechatCode="+wechatCode);
			// 用户同意授权
			if (wechatCode != null && !"authdeny".equals(wechatCode)) {
				...
				request.getSession().setAttribute("refund_wechatUserInfo", wechatUserInfo);
			
				response.sendRedirect(WeixinUtil.hostUrlString+"/mobile/account/gotoApplyRefund.action");
